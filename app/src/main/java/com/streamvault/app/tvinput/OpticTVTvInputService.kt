...
@AndroidEntryPoint
class OpticTVTvInputService : TvInputService() {
    ...
    override fun onCreateSession(inputId: String): Session = OpticTVSession(this)

    private inner class OpticTVSession(context: Context) : Session(context) {
    ...
    private companion object {
        const val TAG = "OpticTVTvInput"
        const val DEFAULT_USER_AGENT = "OpticTVTvInput"
