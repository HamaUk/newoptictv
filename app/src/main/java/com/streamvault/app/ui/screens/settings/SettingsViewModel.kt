...
class SettingsViewModel @Inject constructor(
    ...
    private val authRepository: com.streamvault.domain.repository.AuthRepository
) : ViewModel() {
    ...
    val currentUser = authRepository.currentUser.stateIn(viewModelScope, SharingStarted.WhileSubscribed(5000), null)
