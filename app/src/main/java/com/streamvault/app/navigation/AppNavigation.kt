...
fun AppNavigation(
    ...
    authRepository: com.streamvault.domain.repository.AuthRepository = hiltViewModel<AuthViewModel>().repository
) {
    ...
    NavHost(
        ...
        enterTransition = {
            ...
            scaleIn(initialScale = 0.94f, animationSpec = tween(300, easing = FastOutSlowInEasing))
        },
        exitTransition = {
        ...
        popEnterTransition = {
            fadeIn(animationSpec = tween(300, easing = FastOutSlowInEasing)) +
            scaleIn(initialScale = 1.06f, animationSpec = tween(300, easing = FastOutSlowInEasing))
        },
        popExitTransition = {
            fadeOut(animationSpec = tween(300, easing = FastOutSlowInEasing)) +
        ...
        composable(Routes.LOGIN) {
            com.streamvault.app.ui.screens.login.LoginScreen(
...
// ... (rest of file)
        ...
        composable(Routes.SETTINGS) {
            SettingsScreen(
                ...
                onAddProvider = { navController.navigate(Routes.PROVIDER_SETUP) },
